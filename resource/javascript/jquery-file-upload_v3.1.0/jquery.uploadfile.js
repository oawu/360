...
(function ($) {
    ...
    $.fn.uploadFile = function (options) {
        ...
        var s = $.extend({
            ...
            dragenter_border: '2px solid #A5A5C7',
            drop_border: '2px dotted #A5A5C7',
            dragover_border: '2px dotted #A5A5C7'
        }, options);
        ...
        var uploadLabel = $('<label />').html ($(this).html());
        ...
        function setDragDropHandlers(obj, s, ddObj) {
            ddObj.on('dragenter', function (e) {
                e.stopPropagation();
                e.preventDefault();
                $(this).css('border', s.dragenter_border);
            });
            ...
            $(document).on('dragover', function (e) {
                e.stopPropagation();
                e.preventDefault();
                ddObj.css('border', s.dragover_border);
            });
            $(document).on('drop', function (e) {
                e.stopPropagation();
                e.preventDefault();
                ddObj.css('border', s.drop_border);
            });
